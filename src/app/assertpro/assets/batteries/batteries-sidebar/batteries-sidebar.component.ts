...
@Component({
  selector: 'batteries-sidebar-component',
  templateUrl: './batteries-sidebar.component.html',
  styleUrls: ['./batteries-sidebar.component.css']
})
export class BatteriesSidebarComponent implements OnInit {
