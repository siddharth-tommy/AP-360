...
@Component({
    selector: 'chargertable',
    templateUrl: './chargertable.component.html',
    styleUrls: ['./dashboard.component.css']
  })
  export class Chargertable {
    equipmentOverviewDatas2;
    overView; prodictivemenu;
    titile;
    equipmentOverviewColumn2;
    stateOverview;
    ...
    constructor(private toastr: ToastrService,public dialog: MatDialog, public dialogRef: MatDialogRef<Chargertable>, @Inject(MAT_DIALOG_DATA) public data: any, private assetprohelperService: AssetprohelperService,
    private _router: Router) {
      this.equipmentOverviewDatas2 = data.equipmentOverviewDatas2
      this.overView = data.overView
      this.prodictivemenu = data.prodictivemenu
      this.titile = data.titile
      this.equipmentOverviewColumn2 = data.equipmentOverviewColumn2
      this.stateOverview = data.stateOverview
      this.batteriesEnable = data.batteriesEnable
      this.chargesEnable = data.chargesEnable
      this.dataSource3.data=data.equipmentOverviewDatas2.TableRecords
    }
